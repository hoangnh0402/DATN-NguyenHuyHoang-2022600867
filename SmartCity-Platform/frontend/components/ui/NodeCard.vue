...
-->
<template>
  <div class="glass-card p-5 transition-all duration-300" :class="statusClass">
    ...
    <div
      class="flex items-center justify-between pt-3 border-t border-light-border/50 dark:border-dark-border/50"
    >
      <span
