...
declare global {
  ...
  const useSystemControl: typeof import('../../composables/useSystemControl').useSystemControl
  const useSystemStats: typeof import('../../composables/useSystemStats').useSystemStats
...
declare global {
  ...
  // @ts-ignore
  export type { DataType, CityData, DataFilter, DataResponse } from '../../stores/data'
  import('../../stores/data')
  // @ts-ignore
  export type { EdgeNode, RateSnapshot, SystemStats, BackendHealth } from '../../stores/system'
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useSystemControl: UnwrapRef<typeof import('../../composables/useSystemControl')['useSystemControl']>
    readonly useSystemStats: UnwrapRef<typeof import('../../composables/useSystemStats')['useSystemStats']>
